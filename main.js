...
$('#circle2').click(function() {
    $(this).css({'background' : '#808080'}).parent().find(".timeline__step-line").css({'background' : '#808080'}).parent().parent().find(".timeline__step--third").find(".timeline__step-line, .timeline__step-circle").css({ 'background' : '#dfdfdf'});
});
